...
WebUI.takeFullPageScreenshotAsCheckpoint('NIBMaxDigitBefore')
...
WebUI.click(findTestObject('SCXO_No_OTP/Page_OnBoardingNegative/negative_TC_070_NIBMaxDigit'))

WebUI.delay(5)

WebUI.waitForElementPresent(findTestObject('SCXO_No_OTP/Page_OnBoardingNegative/negative_msg_TC070'), 5)
...
WebUI.takeScreenshotAsCheckpoint('NIBMax1')
...
WebUI.takeFullPageScreenshotAsCheckpoint('NIBMaxdigitAfter')
