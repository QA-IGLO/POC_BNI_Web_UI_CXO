...
WebUI.takeFullPageScreenshotAsCheckpoint('Upload_ADART')
...
CustomKeywords.'upload_file.uploadFileImage'('C:\\2024\\POC BNI\\Find XPath in IE Browser.pdf')
...
WebUI.takeFullPageScreenshotAsCheckpoint('UploadData_After')
