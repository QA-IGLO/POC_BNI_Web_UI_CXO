...
WebUI.callTestCase(findTestCase('6_TC_Detail_Perusahaan - button_selanjutnya_atas'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('7_TC_Alamat_Perusahaan_button_Selanjutnya_atas'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('_11_TC_Cabang_Pendaftaran_TC_093_cabangpendaftarantidakdiisi'), [:], FailureHandling.STOP_ON_FAILURE)
