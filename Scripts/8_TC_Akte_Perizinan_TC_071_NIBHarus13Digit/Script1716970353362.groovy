...
WebUI.takeFullPageScreenshotAsCheckpoint('NIBHarusDigitBefore')
...
WebUI.setText(findTestObject('SCXO_No_OTP/Page_Onboarding/8.16_input_Nomor Izin Usaha NIB_onboardPermitsD_df6ad9'), '12345678901')
...
WebUI.waitForElementPresent(findTestObject('SCXO_No_OTP/Page_OnBoardingNegative/negative_TC_071NIBHarusMemilikdigit'), 5)

WebUI.delay(5)

WebUI.takeScreenshotAsCheckpoint('NIBHarusDigit11')
...
WebUI.takeFullPageScreenshotAsCheckpoint('NIBHarusDigitAfter')
