...
WebUI.takeFullPageScreenshotAsCheckpoint('Akper11')
...
WebUI.waitForElementPresent(findTestObject('SCXO_No_OTP/Page_OnBoardingNegative/_negative_TC_070_NIBMaxDigit'), 5)

WebUI.delay(10)

WebUI.scrollToElement(findTestObject('SCXO_No_OTP/Page_OnBoardingNegative/_negative_TC_070_NIBMaxDigit'), 5)

WebUI.delay(10)

WebUI.takeElementScreenshotAsCheckpoint('NIBMax', findTestObject('SCXO_No_OTP/Page_OnBoardingNegative/_negative_TC_070_NIBMaxDigit'))

WebUI.delay(10)

WebUI.takeFullPageScreenshotAsCheckpoint('NIBMaxDigit')
