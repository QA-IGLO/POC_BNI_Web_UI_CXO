...
WebUI.setText(findTestObject('SCXO_No_OTP/Page_Onboarding/8.16_input_Nomor Izin Usaha NIB_onboardPermitsD_df6ad9'), '45678909856')

WebUI.delay(2)

WebUI.waitForElementPresent(findTestObject('SCXO_No_OTP/Page_Onboarding/negative_TC_071NIBHarusMemilikdigit'), 5)

WebUI.delay(2)

WebUI.scrollToElement(findTestObject('SCXO_No_OTP/Page_Onboarding/negative_TC_071NIBHarusMemilikdigit'), 5)

WebUI.delay(5)

WebUI.takeElementScreenshotAsCheckpoint('NIB harus memiliki 13 digit', findTestObject('SCXO_No_OTP/Page_Onboarding/negative_TC_071NIBHarusMemilikdigit'))

WebUI.delay(10)

WebUI.takeScreenshotAsCheckpoint('NIBHarus13Digit')
