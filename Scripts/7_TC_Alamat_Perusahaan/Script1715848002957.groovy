...
WebUI.takeFullPageScreenshotAsCheckpoint('Alper1')

WebUI.delay(5)

WebUI.takeScreenshotAsCheckpoint('AlamatPerusahaanBefore2')
...
WebUI.setText(findTestObject('SCXO_No_OTP/Page_Onboarding/7_10_input_Nomor Telepon Perusahaan'), '0812456789876')
...
CustomKeywords.'upload_File.screenshoot.screenshotPage'('AlamatPerusahaanAfter')

WebUI.delay(5)

WebUI.takeScreenshotAsCheckpoint('Alamat Perusahaan After 2')
