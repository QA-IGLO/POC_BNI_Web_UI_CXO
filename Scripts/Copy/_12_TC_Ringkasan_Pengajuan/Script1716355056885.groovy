...
WebUI.takeFullPageScreenshotAsCheckpoint('RingkasanPengajuanBefore')
...
WebUI.takeScreenshotAsCheckpoint('Profil Orang Yang berwenang')
...
WebUI.takeScreenshotAsCheckpoint('Detail Perusahaan')
...
WebUI.takeScreenshotAsCheckpoint('Alamat Perusahaan')
...
WebUI.takeScreenshotAsCheckpoint('Akte Perijinan')
...
WebUI.takeScreenshotAsCheckpoint('Dokumen Perusahaan')
...
WebUI.takeScreenshotAsCheckpoint('Kebutuhan Pengguna')
...
WebUI.takeScreenshotAsCheckpoint('System Adminitrator Registration')
...
WebUI.takeFullPageScreenshotAsCheckpoint('RingkasanPengajuanAfter')

WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/BNI CSO/Page_BNIDirect/button_Selanjutnya'))
