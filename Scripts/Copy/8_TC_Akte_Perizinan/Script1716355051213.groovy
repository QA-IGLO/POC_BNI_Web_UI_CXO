...
WebUI.takeFullPageScreenshotAsCheckpoint('AktePerizinanBefore')
...
WebUI.setText(findTestObject('SCXO_No_OTP/Page_Onboarding/8.16_input_Nomor Izin Usaha NIB_onboardPermitsD_df6ad9'), '4567890987656')

WebUI.delay(2)

WebUI.setText(findTestObject('SCXO_No_OTP/Page_Onboarding/8_17_input_Tanggal Pembuatan_onboardPermitsDto.l_ecb58c'), '2020-11-03')

WebUI.delay(2)

WebUI.click(findTestObject('SCXO_No_OTP/Page_Onboarding/_8.20_div_28'))

WebUI.delay(2)

WebUI.setText(findTestObject('SCXO_No_OTP/Page_Onboarding/8.21_input_Tanggal Expired_onboardPermitsDto.lic_eb8bef'), '2027-11-02')

WebUI.delay(2)

WebUI.click(findTestObject('SCXO_No_OTP/Page_Onboarding/_8.22_div_27'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('AktePerizinanAfter')
