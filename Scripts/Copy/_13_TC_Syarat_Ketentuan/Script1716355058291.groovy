...
WebUI.takeFullPageScreenshotAsCheckpoint('SyaratKetentuanBefore')
...
CustomKeywords.'upload_File.screenshoot.screenshotPage'('SyaratKetentuan3')
...
WebUI.takeFullPageScreenshotAsCheckpoint('SyaratKetentuanAfter')

WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/BNI CSO/Page_BNIDirect/button_Selesai  Kirim'))
