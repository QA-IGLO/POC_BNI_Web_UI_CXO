...
WebUI.takeFullPageScreenshotAsCheckpoint('tglUsahaKosongBefore')
...
WebUI.click(findTestObject('SCXO_No_OTP/Page_OnBoardingNegative/negative_TC_052_tanggalUsaha_kosong'))
...
WebUI.scrollToElement(findTestObject('SCXO_No_OTP/Page_OnBoardingNegative/negative_msg_TC052'), 5)

WebUI.delay(5)

WebUI.takeFullPageScreenshotAsCheckpoint('TglUsahaKosongAfter')
