...
CustomKeywords.'upload_File.screenshoot.screenshotPage'('AktePerizinanBefore')
...
WebUI.scrollToElement(findTestObject('SCXO_No_OTP/Page_OnBoardingNegative/negative_TC_071NIBHarusMemilikdigit'), 5)

WebUI.delay(10)

WebUI.takeElementScreenshotAsCheckpoint('NIBKurangDigit', findTestObject('SCXO_No_OTP/Page_OnBoardingNegative/negative_TC_071NIBHarusMemilikdigit'))

WebUI.delay(10)

WebUI.takeScreenshotAsCheckpoint('NIBKurangDigit1')
