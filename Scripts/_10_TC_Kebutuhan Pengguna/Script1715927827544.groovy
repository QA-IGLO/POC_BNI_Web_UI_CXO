...
WebUI.takeFullPageScreenshotAsCheckpoint('PlanBerdasarkanPilihanAnda')
...
WebUI.setText(findTestObject('SCXO_No_OTP/Page_Onboarding/_10.3_input_BusinessID'), 'IDA_311')
...
WebUI.setText(findTestObject('SCXO_No_OTP/Page_Onboarding/_10.7_input_Nomor Handphone_usersDto.makerDto.0.p_72937'), '6281234567812')

WebUI.delay(5)

WebUI.takeScreenshotAsCheckpoint('KebPeng3')

WebUI.delay(2)

WebUI.setText(findTestObject('SCXO_No_OTP/Page_Onboarding/_10.8_input_Alamat Email_usersDto.makerDto.0.email'), 'ida.wasida@gmail.com')
...
WebUI.takeFullPageScreenshotAsCheckpoint('KebutuhanPengguna22')
