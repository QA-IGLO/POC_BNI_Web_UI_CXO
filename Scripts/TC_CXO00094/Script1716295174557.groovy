...
WebUI.callTestCase(findTestCase('9_TC_Upload_data_button_selanjutnya_atas'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('_10_TC_Kebutuhan Pengguna'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('_11_TC_Cabang_Pendaftaran_TC_094_JadwalTidakDiisi'), [:], FailureHandling.STOP_ON_FAILURE)
