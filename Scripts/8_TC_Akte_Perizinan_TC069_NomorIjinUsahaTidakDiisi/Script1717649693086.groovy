...
WebUI.takeFullPageScreenshotAsCheckpoint('NomorIjinUsahaHarusDIisiBefore')
...
WebUI.click(findTestObject('SCXO_No_OTP/Page_OnBoardingNegative/negative_TC_069_NIBKosong'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.delay(10)

WebUI.waitForElementPresent(findTestObject('SCXO_No_OTP/Page_OnBoardingNegative/negative_msg_TC069'), 10)
...
WebUI.takeFullPageScreenshotAsCheckpoint('NomorIjinUsahaHarusDiisiAfter')
